...
public class ConnectionController {
    ...
    public ResponseEntity<Void> connect(@RequestParam int userId, @RequestParam String countryName) throws Exception{
        ...
        //3. Else, the user should be subscribed under a serviceProvider having option to connect
        ...
        // If multiple service providers allow you to connect to the country, use the service provider
        // having smallest id.
